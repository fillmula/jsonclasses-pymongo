...
class TestEncoder(unittest.TestCase):
  ...
  def test_encoder_handle_many_to_many_with_linkedthru(self):
    ...
    self.assertEqual(commands[0].object['difficultEncodeLinkedThruAId'], ObjectId(instance_a.id))
    self.assertEqual(commands[0].object['difficultEncodeLinkedThruBId'], ObjectId(instance_a.blinks[0].id))
    self.assertEqual(commands[0].collection.name, 'difficultencodelinkedthruasblinksdifficultencodelinkedthrubsalinks')
    self.assertEqual(commands[1].object['difficultEncodeLinkedThruAId'], ObjectId(instance_a.id))
    self.assertEqual(commands[1].object['difficultEncodeLinkedThruBId'], ObjectId(instance_a.blinks[1].id))
    self.assertEqual(commands[1].collection.name, 'difficultencodelinkedthruasblinksdifficultencodelinkedthrubsalinks')
