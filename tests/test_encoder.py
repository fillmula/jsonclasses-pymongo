...
class TestEncoder(unittest.TestCase):
  ...
  def test_encoder_handle_many_to_many_with_linkedthru(self):
    ...
    self.assertEqual(commands[0].collection.name, 'difficultencodelinkedthruasdifficultencodelinkedthrubs')
    ...
    self.assertEqual(commands[1].collection.name, 'difficultencodelinkedthruasdifficultencodelinkedthrubs')
